...
class WxPayApi
{
    ...
    public static function unifiedOrder($inputObj, $timeOut = 6)
    {
        ...
        if (@WxPayConfig::SUBAPPID) {
            $inputObj->SetSub_appid(WxPayConfig::SUBAPPID);
        }
        if (@WxPayConfig::SUBMCHID) {
            $inputObj->SetSub_mch_id(WxPayConfig::SUBMCHID);
        }
    ...
    public static function orderQuery($inputObj, $timeOut = 6)
    {
        ...
        $inputObj->SetMch_id(WxPayConfig::MCHID);//商户号
        if (@WxPayConfig::SUBMCHID) {
            $inputObj->SetSub_mch_id(WxPayConfig::SUBMCHID);//商户号
        }
        $inputObj->SetNonce_str(self::getNonceStr());//随机字符串
    ...
    private static function postXmlCurl($xml, $url, $useCert = false, $second = 30)
    {
        ...
        if ($data) {
            ...
            $error = curl_errno($ch);
            \WxLog::error('WxPat.Api.postXmlCurl Error: ' . curl_error($ch));
            curl_close($ch);
